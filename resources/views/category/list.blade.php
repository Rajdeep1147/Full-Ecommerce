						...
						<div class="card">
							<div class="card-header">
								<div class="card-title">
									<button type="button" onclick="window.location.href='{{ route("show.category") }}'" class="btn btn-default btn-sm">Reset</button>
								</div>
										...
										@if(!$categories->isEmpty())
											...
											<tr id= "sid{{ $category->id }}">
												...
												<td>
													...
													<a href="javascript:void(0)" onclick="deleteCategory({{$category->id  }})" class="text-danger w-4 h-4 mr-1 deleteData">
