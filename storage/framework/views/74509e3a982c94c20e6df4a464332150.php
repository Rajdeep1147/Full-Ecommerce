                                ...
                                <div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="name" id="name" class="form-control" value="<?php echo e($category->name); ?>" placeholder="Name">	
									...
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="slug" id="slug" class="form-control" value="<?php echo e($category->slug); ?>" placeholder="Slug">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											<div class="form-group">
												<label>Status</label>
												<select class="form-control" name="status" value="<?php echo e($category->status); ?>">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<?php if($category->image): ?>
												<img src="<?php echo e(asset('new_image/' . $category->image)); ?>" alt="Category Image" height="100px" width="220px">
											<?php else: ?>
											...
											<small id="imageHelpBlock" class="form-text text-muted"><?php if($category->image): ?> <?php else: ?> Please choose an image file (JPG, JPEG, PNG, or GIF). <?php endif; ?></small>
										</div>
...
<script>
    $(document).ready(function(){
        $("#category-edit").submit(function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route("update.category",$category->id)); ?>',
                data: formData,
                processData: false,
                contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rocky/ecommerce/resources/views/category/edit-category.blade.php ENDPATH**/ ?>